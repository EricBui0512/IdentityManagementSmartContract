...
contract NextIdTokenSale is ContributorApprover{
    ...
    _publicSaleEndTime )
    {
        ...
        token = new NextIdToken( _totalTokenSupply,
        _cappedSaleStartTime,
